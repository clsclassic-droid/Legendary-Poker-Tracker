...
function PlayerProfilesView({ data, initialSel=null, onClearSel }) {
  ...
  // Player list
  const DEFAULT_AVATAR = "https://raw.githubusercontent.com/clsclassic-droid/Legendary-Poker-Tracker/main/src/2D7446EF-44B7-4B82-AF7E-3E10C5ED5A28.png";
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-2">
          {players.map(p => (
            <div key={p} className="border border-zinc-700/30 rounded-xl px-3 py-2 space-y-1.5" style={{background:"rgba(255,255,255,0.06)"}}>
              <div className="flex items-center gap-2">
                <img src={avatars[p] || "https://raw.githubusercontent.com/clsclassic-droid/Legendary-Poker-Tracker/main/src/2D7446EF-44B7-4B82-AF7E-3E10C5ED5A28.png"} alt={p}
