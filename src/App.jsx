...
function Box({ children, className="" }) {
  return <div className={"border border-zinc-700/50 rounded-2xl p-4 " + className}
    style={{background:'rgba(15,10,3,0.25)', backdropFilter:'blur(14px)', WebkitBackdropFilter:'blur(14px)'}}
  >{children}</div>;
}
...
function MiniChart({ player, sessions }) {
  ...
  if (pts.length < 2) return (
    <div className="border border-zinc-700/50 rounded-2xl" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}} className2=" p-6 text-center">
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <button onClick={()=>leader&&onGoLeader(leader.name)}
          className="border border-amber-500/40 rounded-2xl p-3 text-left hover:border-amber-400/70 transition-colors" style={{background:"rgba(25,14,2,0.3)",backdropFilter:"blur(14px)"}}>
        ...
        <button onClick={()=>latest&&onGoLatestSes(latest.internalId)}
          className="border border-zinc-700/50 rounded-2xl p-3 text-left hover:border-zinc-600 transition-colors" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
        ...
        <button onClick={onGoPot}
          className="border border-purple-500/30 rounded-2xl p-3 text-left hover:border-purple-400/60 transition-colors" style={{background:"rgba(15,8,25,0.3)",backdropFilter:"blur(14px)"}}>
      ...
      <div className="grid grid-cols-4 gap-2">
        {[
          ...
          <div key={label} className="border border-zinc-700/50 rounded-xl px-2 py-2 text-center" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
  ...
  if (sel) {
    ...
    return (
      <div className="space-y-4">
        ...
        {/* Total */}
        <div className="text-center py-4 border border-zinc-700/50 rounded-2xl" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div key={label} className="border border-zinc-700/50 rounded-xl p-3 text-center" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
        ...
        <div>
          ...
          <div className="space-y-1.5">
            {history.map((x,i) => {
              ...
              return (
                <div key={i} className="flex items-center justify-between border border-zinc-700/50 rounded-xl px-3 py-2" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
      ...
      <div className="space-y-2">
        {summary.map(p => (
          <button key={p.name} onClick={()=>setSel(p.name)}
            className="w-full flex items-center gap-3 border border-zinc-700/50 hover:border-zinc-600/70 rounded-2xl px-4 py-3 text-left transition-colors" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
...
function RacingBarChart({ sessions, players, nicknames }) {
  ...
  return (
    <div className="border border-zinc-700/50 rounded-2xl" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}} className2=" p-4 space-y-3">
      {/* Header */}
  ...
  return (
    <div className="space-y-4">
      ...
      {[...data.sessions].reverse().map(s => {
        ...
        return (
          <div key={s.internalId} className="border border-zinc-700/50 rounded-2xl" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}} className2=" overflow-hidden">
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        {pot.transactions.map(tx => (
          <div key={tx.id} className="flex items-center justify-between border border-zinc-700/50 rounded-xl px-4 py-3" style={{background:"rgba(15,10,3,0.25)",backdropFilter:"blur(14px)"}}>
            <div className="flex items-center gap-3">
