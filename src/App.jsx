      ...
      <div className="flex gap-3">
        <div style={{width:"40%"}}>
          ...
          <input type="date" value={date} onChange={e=>setDate(e.target.value)}
            className="w-full border border-zinc-700/40 rounded-lg px-2 py-2 text-white text-sm focus:border-amber-500 focus:outline-none" style={{background:"rgba(255,255,255,0.06)"}}/>
